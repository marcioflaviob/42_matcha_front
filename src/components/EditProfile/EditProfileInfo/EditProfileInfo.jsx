...
const EditProfileInfo = ({ userId }) => {
    ...
    const handleRemoveChip = async (interestId) =>
    {
    ...
    <div className='bio-Div'>
        ...
        <div className='bio-containerInterest'>
                {interests?.map((interest) => (
                    <Chip className='bio-interest' label={interest.name} key={interest.id} removable onRemove={() => handleRemoveChip(interest.id)}/>
                ))}
        </div>
        <div className='bio-container'>
